  ...
  return (
    <section id="services" className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-16 animate-in fade-in slide-in-from-bottom duration-1000 ease-out">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <Card 
              key={index} 
              className={cn(
                "group relative border-2 transition-all duration-500 hover:shadow-2xl hover:-translate-y-3 rounded-[3rem] overflow-hidden bg-white animate-in fade-in slide-in-from-bottom fill-mode-both",
                service.accent
              )}
            ...
            >
              <CardHeader className="space-y-8 p-10">
                <div className={cn(
                  "w-16 h-16 rounded-[1.5rem] flex items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:rotate-6 shadow-xl text-white",
                  service.color,
                  service.shadow
                )}>
                ...
                <div className="space-y-4">
                  ...
                  <CardDescription className="text-lg leading-relaxed text-muted-foreground/90 font-medium">
                    {service.description}
                  </CardDescription>
                </div>
              </CardHeader>
              <div className="px-10 pb-10">
                <button className="text-base font-bold text-primary flex items-center gap-2 group/btn hover:underline underline-offset-8 decoration-2 transition-all">
                  Learn More 
