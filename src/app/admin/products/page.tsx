  ...
  return (
    <main className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center space-y-8">
      ...
      <div className="space-y-2">
        <h1 className="text-4xl font-headline font-black italic">Portal Removed</h1>
        <p className="text-muted-foreground font-medium max-w-sm mx-auto">Administrative product management is no longer available.</p>
      </div>
      <Link href="/">
